...
def build_trust_store_profile(ccadb_records):
    ...
    for ca_owner, data in owners.items():
        ...
        profiles[ca_owner] = {
            ...
            "intermediates_count": data["intermediates_count"],
        ...
        profiles[ca_owner]["intermediates"] = trusted_intermediates
...
def build_ca_detail_records(ccadb_profiles):
...
def main():
    ...
    ca_details = build_ca_detail_records(ccadb_profiles)
